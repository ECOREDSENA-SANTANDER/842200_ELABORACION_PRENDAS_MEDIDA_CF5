  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          .h4 Conceptos de Elaboración de modelos masculinos. 
        p.mb-4 Identificar la apropiación de los contenidos en la temática patrones y modelos de prendas masculinas 
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 A continuación, encontrará conceptos del material de estudio. 
            .col-auto
