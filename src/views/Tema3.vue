...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
          ...
          table
            ...
            tbody
              tr
                ...
                td.text-center 28 cm
              tr
                td.text-center Contorno de Cadera
                td.text-center 86,5 cm
              tr
                td.text-center Largo de pantalón
                td.text-center 106,1 cm
              tr
    ...
    p.mb-4 En este caso, el Manual de patronaje básico e interpretación de diseños sugiere trabajar la base de pantalón sin margen de costura, sin embargo, se puede trabajar de cualquier manera, es decir, se puede implementar el cuadro de margen de costura, trabajado en infantil, o se puede hacer el trazo tal cual como indica el Manual.
